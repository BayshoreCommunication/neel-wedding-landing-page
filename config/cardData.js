 ...
 const cardData = [
    {
        ...
        description: "Meet my sister, Hafeza. Our bond, built on love and shared memories, has grown stronger over time. From childhood mischief to today, she's shaped who I am. Our relationship is rooted in trust, laughter, and a deep sisterhood. I'm grateful to have her as both family and friend.",
    },
    {
        id: 2,
        title: "Best Man",
        ...
        description:"Meet my baby brother, Mockles. From day one, he’s been my partner in crime. Our bond is unbreakable, filled with childhood adventures and shared memories. No matter how we grow, he’ll always hold a special place in my heart as my little brother, friend, and constant support."
    },{
        id: 8,
        title: "Groomsman",
        name:"Oniruddho Rick ",
        image: "/Mask group (7).png",
        description:"Meet Oniruddho Rick, my baby brother and partner in building a toy store startup, is a fellow animal lover—our bond deepened with our shared love for our dogs, both named Tripod. A sharpshooter and a playful spirit, he’s my partner in crime and a true cornerstone of every adventure."
    },{
        id: 9,
        title: "Bridesmaid",
        name:"Tasheira Gary ",
        image: "/Mask group (8).png",
        description:"Meet Tasheria, my birthday twin and travel buddy. We've shared unforgettable adventures around the world, from Ibiza’s beaches to Montreal’s vibrant streets. Our bond grows stronger with every journey, creating memories that will last a lifetime. I’m grateful for her friendship, laughter, and the adventures yet to come."
    },{
        id: 10,
        title: "Groomsman",
        name:"Al Shahriar Shaan",
        image: "/Mask group (9).png",
        description:"Meet Al Shahriar Shaan, my childhood best friend since preschool, reconnected at USF and now my business partner, is the ultimate groomsman. Known for his playful charm and constant teasing, he’s a loyal friend and a natural player. With Shaan, life’s always an adventure filled with wit, fun, and camaraderie."
    },{
        id: 11,
        title: "Bridesmaid",
        name:"Ayesha Tasmia",
